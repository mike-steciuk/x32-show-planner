...
const PRESETS = {
  ...
  guitar: { eq: neutralEq(80, [{ type: 'PEQ', f: 280, g: -1.5, q: 1.2 }, { type: 'PEQ', f: 2800, g: 1, q: 1.5 }, { type: 'HShv', f: 8500, g: -1, q: .7 }]), gate: { on: false, threshold: -62, range: 8, attack: 8, hold: 160, release: 320 }, compressor: { on: false, threshold: -16, ratio: '2.0', attack: 20, hold: 20, release: 140, makeup: 0 } },
...
const DRUMS = {
  kick: { eq: neutralEq(40, [{ type: 'PEQ', f: 70, g: 3, q: 1.1 }, { type: 'PEQ', f: 350, g: -4, q: 1.4 }, { type: 'PEQ', f: 3500, g: 3, q: 1.5 }]), gate: { on: true, threshold: -46, range: 18, attack: 2, hold: 140, release: 240 }, compressor: { on: true, threshold: -18, ratio: '4.0', attack: 20, hold: 10, release: 100, makeup: 0 } },
  snare: { eq: neutralEq(90, [{ type: 'PEQ', f: 180, g: 2, q: 1.1 }, { type: 'PEQ', f: 700, g: -3, q: 1.5 }, { type: 'PEQ', f: 5000, g: 2.5, q: 1.4 }]), gate: { on: true, threshold: -50, range: 14, attack: 2, hold: 180, release: 300 }, compressor: { on: true, threshold: -16, ratio: '4.0', attack: 12, hold: 10, release: 110, makeup: 0 } },
  tom: { eq: neutralEq(55, [{ type: 'PEQ', f: 120, g: 2, q: 1.1 }, { type: 'PEQ', f: 450, g: -3, q: 1.4 }, { type: 'PEQ', f: 4000, g: 2, q: 1.4 }]), gate: { on: true, threshold: -50, range: 16, attack: 4, hold: 220, release: 380 }, compressor: { on: true, threshold: -16, ratio: '3.0', attack: 18, hold: 10, release: 140, makeup: 0 } },
